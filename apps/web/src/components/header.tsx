...
import { Menu, X, ChevronDown, ArrowRight, Sparkles, Github } from 'lucide-react';
        ...
        <div className="flex h-16 items-center justify-between lg:h-20">
          ...
          <div className="hidden items-center space-x-4 lg:flex">
            <Link
              ...
              aria-label="GitHub"
              className="text-foreground transition-colors duration-200 hover:text-rose-500"
            >
            ...
            >
              <div className="border-border bg-background/95 mt-4 space-y-2 rounded-xl border py-4 shadow-xl backdrop-blur-lg">
                ...
                <div className="space-y-2 px-4 py-2">
                  <Link
                    href={siteConfig.links?.github || ''}
                    className="text-foreground hover:bg-muted flex items-center justify-center gap-2 w-full rounded-lg py-2.5 text-center font-medium transition-colors duration-200"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
