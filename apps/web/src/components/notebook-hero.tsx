...
export default function NotebookHero() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-6 sm:py-14">
      ...
      <main className="relative mt-4 py-4 lg:py-8 text-center md:text-left">
        <div className="relative sm:overflow-hidden">
          <div className="border-primary/20 bg-background/70 shadow-primary/10 relative mx-auto flex flex-col items-start justify-start rounded-xl border px-6 md:px-12 pt-12 md:pt-16 shadow-xl backdrop-blur-md max-md:text-center w-full">
            <div
            ...
            />
            <h1 className="mb-4 flex flex-wrap justify-center md:justify-start gap-2 text-3xl leading-tight font-medium md:text-5xl">
              Your<span className="text-primary">daily</span> 2b2t
              RSS feed
            </h1>
            <p className="text-muted-foreground mb-8 text-center md:text-left md:mx-0 mx-auto md:max-w-[80%] md:text-xl">
              Our AI driven scrapers collect gossip, news, and updates from
              across the 2b2t community, delivering them straight to you.
            </p>
            ...
            <div className="z-10 mt-2 inline-flex items-center justify-center md:justify-start gap-3 w-full">
              <a
                href="#"
                className={cn(
                  buttonVariants({
              ...
              >
                View RSS <ArrowRight className="size-4" />
              </a>
              <a
                href="https://github.com/youngfizzler/hausefeed"
                target="_blank"
